            ...
            appBar: AppBar(
              bottom: TabBar(
                tabs: [
                  ...
                  Tab(icon: Text("UpComing",style:
                      TextStyle( fontSize: 10))),
                  Tab(icon: Text("TopRated",style:
                  TextStyle( fontSize: 10))),
                  Tab(icon: Text("Popular",style:
                  TextStyle( fontSize: 10))),
                  Tab(icon: Text("Favourite",style:
                  TextStyle( fontSize: 10)),)
