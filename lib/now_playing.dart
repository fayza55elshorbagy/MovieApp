...
class NowPlaying extends StatefulWidget {
  NowPlaying({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<NowPlaying> {
  int _counter = 0;
  List<Movie> movies = [];
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                //Image.network('${movies[index].backdropPath}'),
                                Container(
                                  child: Hero(
                                    tag: '${movies[index].id}',
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(
                                          padding: new EdgeInsets.fromLTRB(2, 10, 0, 0),
                                          child: Text(
                                ...
                                Container(
                                  child: GestureDetector(
                                    onTap:(){
                                      ...
                                      Provider.of<MoviesModel>(context,listen: false).addMovie(movies[index]);
